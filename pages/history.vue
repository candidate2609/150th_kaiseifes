  ...
  <main>
    ...
    <section>
      <div class="container">
        ...
        <p>平成9年には老朽化などの問題があった中学校舎を新築した。平成12年（2000）より開成マラソンのコースが荒川河川敷に移された。その後、中学1年生が全員参加する水泳学校の復活や、ペン剣基金による研究助成制度が創設が行われ、英語学校が始められる。そして2021年、150周年記念事業により、新高校校舎が落成した。</p>
      </div>
    </section>
  </main>
</template>
