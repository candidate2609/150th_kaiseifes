<template>
  <main>
    ...
    <section>
      <div class="container">
        <era-title id="5">そして未来へ</era-title>
        <p>昭和61年（1986）、事務局、食堂、図書館などを含む高等学校本館が完成し、懸案だった新しい時代に向けての環境整備が一段落した。</p>
        <p>1980年代には、生徒が主体となって運営する運動会が安全面や運営方法でさまざまな問題点を抱えていた。問題点を無くし、より良い運動会へとする為に、教員の粘り強い指導と生徒間の議論が絶えず繰り返された。</p>
        <p>平成9年（1997）には老朽化などの問題があった中学校舎を新築した。平成12年（2000）より開成マラソンのコースが荒川河川敷に移された。その後、中学1年生が全員参加する水泳学校の復活や、ペン剣基金による研究助成制度が創設が行われ、英語学校が始められる。そして2021年、150周年記念事業により、新高校校舎が落成した。場所を変え、時代を変え、校舎を変えど、「開成」というものにこれからもずっと多くの人が夢を刻んでいくのだろう。</p>
      </div>
    </section>
  </main>
</template>
